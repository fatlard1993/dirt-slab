...
public class SlabCaveVinesPlantBlock extends PlantBlock implements Fertilizable, CaveVines {
	public static final MapCodec<SlabCaveVinesPlantBlock> CODEC = createCodec(SlabCaveVinesPlantBlock::new);
	...
	public SlabCaveVinesPlantBlock(Settings settings) {
		super(settings);
