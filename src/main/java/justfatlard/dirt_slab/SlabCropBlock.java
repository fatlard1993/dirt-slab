...
public class SlabCropBlock extends CropBlock {
	...
	private static final VoxelShape[] OFFSET_AGE_TO_SHAPE = new VoxelShape[]{
		...
		Block.createCuboidShape(0.0, -8.0, 0.0, 16.0, 2.0, 16.0),    // age 4
		Block.createCuboidShape(0.0, -8.0, 0.0, 16.0, 4.0, 16.0),    // age 5
		Block.createCuboidShape(0.0, -8.0, 0.0, 16.0, 6.0, 16.0),    // age 6
		Block.createCuboidShape(0.0, -8.0, 0.0, 16.0, 8.0, 16.0)     // age 7
	};

	private final ItemConvertible seedsItem;

	public SlabCropBlock(Settings settings, ItemConvertible seedsItem) {
		super(settings);
